...
MAKE_LOGFILE = /tmpwayofdev-laravel-request-query-builder.log
MAKE_CMD_COLOR := $(BLUE)
...
help:
	...
	@echo
	@echo '    📦 Package                 laravel-request-query-builder (github.com/wayofdev/laravel-request-query-builder)'
